...
let navBottom = document.querySelector("header .bottom");
...
onscroll = _=>{
    if (scrollY > 100) {
        navBottom.classList.add("fixed-top" ,  "bg-white" , "shadow-sm")
        goUpBtn.classList.remove("opacity-0")
    }else{
        navBottom.classList.remove("fixed-top" ,  "bg-white" , "shadow-sm")
        goUpBtn.classList.add("opacity-0")
